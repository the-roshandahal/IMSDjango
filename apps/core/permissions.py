...
ROLE_CAPABILITIES = {
    ...
    ("wh_supervisor", "vehicle.usage.record"): True,
    ...
    ("station_supervisor", "vehicle.usage.record"): True,
    ...
    ("wh_staff", "vehicle.usage.record"): True,
    ...
    ("station_staff", "vehicle.view_own"): True,
    ("station_staff", "vehicle.usage.record"): True,
...
CAPABILITY_CATALOG = [
    ...
    ("Vehicles", [
        ...
        ("vehicle.usage.record", "Record equipment/chemicals used from a vehicle"),
    ]),
    ("Deep Clean Projects", [
...
CAPABILITY_REQUIRES = {
    ...
    "vehicle.usage.record": "vehicle.view_own",
