...
class VehicleAdmin(admin.ModelAdmin):
    list_display = ("registration", "status", "current_station", "assigned_driver", "service_due_date", "insurance_expiry")
    list_filter = ("status",)
...
class VehicleLogAdmin(admin.ModelAdmin):
    list_display = ("vehicle", "action", "station", "driver", "performed_by", "timestamp")
    list_filter = ("action",)
...
class VehicleCostLogAdmin(admin.ModelAdmin):
    list_display = ("vehicle", "cost_type", "amount", "incurred_at", "station", "recorded_by")
